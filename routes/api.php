...
Route::group(['prefix' => 'parent'], static function () {
    ...
    Route::group(['middleware' => ['auth:sanctum',]], static function () {
        ...
        Route::group(['middleware' => ['auth:sanctum', 'checkChild']], static function () {
            ...
            Route::post('make-fees-transaction', [ParentApiController::class, 'makeFeesTransaction']); //Fees Details
            Route::post('complete-fees-transaction', [ParentApiController::class, 'completeFeeTransaction']); //Store Fees
