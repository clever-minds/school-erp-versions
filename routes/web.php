...
//        Route::get('exam/timetable/{id}', [ExamController::class, 'indexExamTimetable'])->name('exam.timetable.index');
        ...
        // TODO make two groups promote student and transfer student and classfiy the routes related to their group
        ...
        Route::post('transfer-student-store', [PromoteStudentController::class, 'storeTransferStudnet'])->name('transfer-student.store');
...
//        Route::get('sendtest', [SettingController::class, 'test_mail']);
        ...
        Route::group(['prefix' => 'fees'], static function () {
            ...
            Route::delete("/{id}/deleted", [FeesController::class, 'trash'])->name('fees.trash');
            Route::delete("/remove-installment-data/{id}", [FeesController::class, 'removeInstallmentData'])->name('fees.remove-installment-data');

            // Fees Class
            Route::get('/classes/{id}', [FeesController::class, 'feesClassListIndex'])->name('fees.class-index');
            Route::get('/classes-list', [FeesController::class, 'feesClassList'])->name('fees.class-list');
            Route::get('/classes-edit/{classId}', [FeesController::class, 'feesClassEdit'])->name('fees.class-edit');
            Route::post('/classes-update', [FeesController::class, 'updateFeesClass'])->name('fees.class-update');
            Route::delete('/remove-fees-class/{id}', [FeesController::class, 'removeFeesClass'])->name('fees.remove-fees-class');
            ...
            Route::get('/paid/compulsory', [FeesController::class, 'compulsoryFeesPaid'])->name('fees.compulsory.index');
            Route::get('/paid/optional/{student_id}', [FeesController::class, 'optionalFeesPaid'])->name('fees.optional.index');
            Route::get('/paid/list', [FeesController::class, 'feesPaidList'])->name('fees.paid.list');
            ...
            Route::delete('/paid/remove-optional-fee/{id}', [FeesController::class, 'removeOptionalFees'])->name('fees.paid.remove.choiceable.fees');
            ...
            Route::delete('/paid/clear-data/{id}', [FeesController::class, 'clearFeesPaidData'])->name('fees.paid.clear.data');
            ...
            Route::post('/compulsory-paid/store', [FeesController::class, 'compulsoryFeesPaidStore'])->name('fees.compulsory-paid.store');
            ...
            Route::get('/fees-receipt', static function () {
        ...
        Route::group(['prefix' => 'system-settings'], static function () {
            ...
            Route::put('payment', [SystemSettingsController::class, 'paymentUpdate'])->name('system-settings.payment.update');
        ...
        Route::group(['prefix' => 'schools'], static function () {
            ...
            Route::get('/change/status/{id}', [SchoolController::class, 'changeStatus']);
        ...
        Route::group(['prefix' => 'subscriptions'], static function () {
            ...
            // Route::get('/subscription/show', [SchoolController::class, 'subscription_show']);
        ...
        Route::group(['prefix' => 'addons'], static function () {
            ...
            Route::get('status/{id}', [AddonController::class, 'status'])->name('addons.status');
