...
use App\Http\Controllers\AcademySetupWizardController;
...
use App\Http\Controllers\CertificateAssignmentController;
use App\Http\Controllers\ClassGroupController;
use App\Http\Controllers\SuperAdmin\AcademySetupController;
...
// Route::get('/login-modern', function() {
//     return view('auth.login-modern');
// });

// Route::get('/login-modern', [AuthController::class, 'modern'])->name('login.modern');
...
Route::group(['middleware' => ['CheckForMaintenanceMode']], static function () {
    ...
    Route::get('/login-with-demo/{id}', [SchoolController::class, 'loginWithDemo'])->name('schools.login-with-demo');
...
Route::group(['middleware' => ['Role', 'checkSchoolStatus', 'status', 'SwitchDatabase', 'verifiedEmail', 'CheckForMaintenanceMode', '2fa', 'wizardSettings']], static function () {
    ...
    Route::get('skip-academy-setup-wizard', [AcademySetupWizardController::class, 'skipAcademySetupWizard'])->name('skip-academy-setup-wizard');

    Route::group(['prefix' => 'academy-setup-wizard', 'as' => 'academy-setup-wizard.'], static function () {
        Route::get('/', [AcademySetupWizardController::class, 'index'])->name('index')->middleware('academySetupWizard');
        Route::post('/submit', [AcademySetupWizardController::class, 'submit'])->name('submit');
        Route::get('/progress/{runId}', [AcademySetupWizardController::class, 'progress'])->name('progress');
    });

    Route::group(['middleware' => ['language', 'academySetupWizard']], static function () {
        ...
        Route::get('reset-wizard-settings/', [WizardSettingsController::class, 'resetWizardSettings'])->name('wizard-settings.reset');

        // server configuration check (after wizard-settings)
        Route::get('server-config', [ServerConfigController::class, 'index'])->name('server-config.index');
        Route::post('server-config/test-database', [ServerConfigController::class, 'testDatabasePrivileges'])->name('server-config.test-database');
        Route::post('server-config/test-queue', [ServerConfigController::class, 'testQueueWorker'])->name('server-config.test-queue');
        Route::post('server-config/test-reverb', [ServerConfigController::class, 'testReverbWorker'])->name('server-config.test-reverb');
        Route::post('server-config/complete', [ServerConfigController::class, 'markComplete'])->name('server-config.complete');
        ...
        Route::group(['prefix' => 'schools'], static function () {
            ...
            Route::get('/login/{id}', [SchoolController::class, 'login'])->name('schools.login');
        });
        ...
        Route::group(['prefix' => 'subscriptions'], static function () {
            ...
            Route::get('report/schools/show', [SubscriptionController::class, 'subscription_report_schools_show']);
            Route::get('report/school/{id}', [SubscriptionController::class, 'school_subscription_detail'])->name('school.subscription.detail');
            Route::get('report/school/{id}/show', [SubscriptionController::class, 'school_subscription_detail_show']);
            Route::get('report/school/subscription/{id}/details', [SubscriptionController::class, 'getSubscriptionDetails'])->name('school.subscription.details.data');
            Route::post('report/school/subscription/{id}/feature', [SubscriptionController::class, 'addSubscriptionFeature'])->name('school.subscription.feature.add');
            Route::delete('report/school/subscription/feature/{id}', [SubscriptionController::class, 'removeSubscriptionFeature'])->name('school.subscription.feature.remove');
            Route::post('report/school/subscription/{id}/addon', [SubscriptionController::class, 'addSubscriptionAddon'])->name('school.subscription.addon.add');
            Route::delete('report/school/subscription/addon/{id}', [SubscriptionController::class, 'removeSubscriptionAddon'])->name('school.subscription.addon.remove');
            ...
            Route::post('assign-plan', [SubscriptionController::class, 'assign_plan'])->name('subscription.assign-plan');
            ...
            Route::post('assign-plan', [SubscriptionController::class, 'assignPlan'])->name('subscriptions.assign-plan');
        });
        ...
        Route::group(['prefix' => 'system-settings'], static function () {
            ...
            Route::get('health', [SystemSettingsController::class, 'health'])->name('system-settings.health');
            Route::post('health/test-database', [ServerConfigController::class, 'testDatabasePrivileges'])->name('system-settings.health.test-database');
            Route::post('health/test-queue', [ServerConfigController::class, 'testQueueWorker'])->name('system-settings.health.test-queue');
            Route::post('health/test-reverb', [ServerConfigController::class, 'testReverbWorker'])->name('system-settings.health.test-reverb');
        });

        Route::resource('system-settings', SystemSettingsController::class);


        Route::group(['prefix' => 'system-update', 'as' => 'system-update.'], static function () {
            Route::get('/', [SystemUpdateController::class, 'index'])->name('index');
            Route::post('/', [SystemUpdateController::class, 'update'])->name('update');
            Route::get('/status/{runId}', [SystemUpdateController::class, 'status'])->name('status');
            Route::get('/school-tracks', [SystemUpdateController::class, 'schoolTracks'])->name('school-tracks');
            Route::post('/retry-school', [SystemUpdateController::class, 'retrySchool'])->name('retry-school');
            Route::post('/post-task', [SystemUpdateController::class, 'postUpdateTask'])->name('post-task');
            Route::post('/toggle-maintenance', [SystemUpdateController::class, 'toggleMaintenance'])->name('toggle-maintenance');
        });
        ...
        // Academy Setup
        Route::group(['prefix' => 'academy-setup', 'as' => 'academy-setup.'], static function () {
            Route::get('/', [AcademySetupController::class, 'index'])->name('index');
            Route::post('/master-status', [AcademySetupController::class, 'updateMasterStatus'])->name('update-master-status');
            Route::get('/{type}/show', [AcademySetupController::class, 'show'])->name('show');
            Route::post('/{type}', [AcademySetupController::class, 'store'])->name('store');
            Route::put('/{type}/{id}', [AcademySetupController::class, 'update'])->name('update');
            Route::delete('/{type}/{id}/destroy', [AcademySetupController::class, 'destroy'])->name('destroy');
            Route::post('/{type}/reorder', [AcademySetupController::class, 'reorder'])->name('reorder');
        });
        ...
        Route::group(['prefix' => 'staff'], static function () {
            ...
            Route::get('payroll-structure/{id}/{type?}', [StaffController::class, 'viewSalaryStructure'])->name('staff.payroll-structure');
            ...
            Route::get('my-certificate', [StaffController::class, 'myCertificate'])->name('staff.my-certificate');
            Route::get('my-certificate/show', [StaffController::class, 'showMyCertificates'])->name('staff.my-certificate.show');
            Route::get('my-certificate/view/{id}', [StaffController::class, 'viewMyCertificate'])->name('staff.my-certificate.view');
        });
        ...
        Route::group(['prefix' => 'syllabus', 'as' => 'syllabus.'], static function () {
            Route::put("/{id}/change-status", [SyllabusController::class, 'changeStatus'])->name('change-status');
        });
        ...
        Route::group(['prefix' => 'class-section'], static function () {
            ...
            Route::post('reset/{id}', [ClassSectionController::class, 'resetClassSectionData'])->name('class-section.reset');
        });
        ...
        Route::group(['prefix' => 'teachers'], static function () {
            ...
            Route::get('payroll-structure/{id}/{type?}', [StaffController::class, 'viewSalaryStructure'])->name('teachers.payroll-structure');
        });
        ...
        /*** Holiday ***/
        Route::get('holiday/check-approved-leaves', [HolidayController::class, 'checkApprovedLeaves'])->name('holiday.check-approved-leaves');
        ...
        Route::group(['prefix' => 'session-year'], static function () {
            ...
            Route::post("/set-session-year", [SessionYearController::class, 'setSessionYear'])->name('session-year.set-session-year');
            Route::get("/get-semesters/{session_year_id}", [SessionYearController::class, 'getSemesters'])->name('session-year.get-semesters');
            Route::get("/cleanup-info/{id}", [SessionYearController::class, 'cleanupInfo'])->name('session-year.cleanup-info');
            Route::post("/cleanup-data/{id}", [SessionYearController::class, 'cleanupData'])->name('session-year.cleanup-data');
        });
        ...
        Route::get('transfer-student', [PromoteStudentController::class, 'transferStudentIndex'])->name('transfer-student.index');
        ...
        Route::post("/set-semester", [SemesterController::class, 'setViewingSemester'])->name('semester.set-viewing-semester');
        ...
        Route::group(['prefix' => 'fees'], static function () {
            ...
            Route::delete("/transaction/{id}", [FeesController::class, 'deleteTransaction'])->name('fees.transaction.delete');
            ...
            // Receipt
            Route::get('paid/receipt-pdf/{id}/{studentId}', [FeesController::class, 'feesPaidReceiptPDF'])->name('fees.paid.receipt.pdf');
        ...
        Route::group(['prefix' => 'certificate'], static function () {
            ...
            Route::post('/', [CertificateTemplateController::class, 'certificate_generate'])->name('certificate.generate');
        ...
        // ---- Certificate Assignment Module ----
        Route::prefix('certificate-assign')->group(function () {
            Route::get('/', [CertificateAssignmentController::class, 'index'])->name('certificate-assign.index');
            Route::post('assign', [CertificateAssignmentController::class, 'assign'])->name('certificate-assign.assign');
            Route::post('revoke', [CertificateAssignmentController::class, 'revoke'])->name('certificate-assign.revoke');
            Route::get('students', [CertificateAssignmentController::class, 'students'])->name('certificate-assign.students');
            Route::get('staff', [CertificateAssignmentController::class, 'staffList'])->name('certificate-assign.staff');
            Route::get('history', [CertificateAssignmentController::class, 'history'])->name('certificate-assign.history');
        });
        ...
        Route::put('tasks/update-status/{id}', [TaskController::class, 'updateStatus'])->name('tasks.update-status');
        ...
        Route::get('reports/student/diary-report', [ReportsController::class, 'getStudentDiaryReport'])->name('reports.student.diary.report');
        Route::get('reports/student/transportation-attendance-report', [ReportsController::class, 'getStudentTransportationAttendanceReport'])->name('reports.student.transportation_attendance.report');
        ...
        Route::get('reports/staff', [ReportsController::class, 'staff_reports'])->name('reports.staff.staff-reports');
        Route::get('reports/staff/staff-reports/show', [ReportsController::class, 'staff_reports_show'])->name('reports.staff.staff-reports.show');
        Route::get('reports/staff/staff-view-reports/{id}', [ReportsController::class, 'staff_view_reports'])->name('reports.staff.staff-view-reports');
        ...
        Route::get('reports/transportation-logs-show/{user_id}', [ReportsController::class, 'transportationLogsShow'])->name('reports.transportation-logs.show');
    });
    ...
    Route::prefix('pickup-points')->name('pickup-points.')->group(function () {
    ...
    Route::get('route/change-order/{id}', [RouteController::class, 'changeOrderIndex'])->name('routes.change-order');
    ...
    Route::resource('route', RouteController::class)->names('routes');

    Route::get("route-vehicle/report/{id}", [RouteVehicleController::class, 'routeVehicleReports'])->name('route-vehicle.routeVehicle-reports');
    ...
    Route::get('route-vehicle/trip-reports/{id?}', [RouteVehicleController::class, 'getTripReports'])->name('route-vehicle.trip-reports');
...
Route::get('demo-tokens', static function () {
    ...
    $guardian = User::where('email', '=', 'guardian@gmail.com', 'and')->first();
    if (!empty($guardian)) {
    ...
    $student = User::where('email', '=', 'student@gmail.com', 'and')->first();
    if (!empty($student)) {
