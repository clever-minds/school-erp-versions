    ...
    <ul class="nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="academics-menu">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        @canany(['class-list', 'syllabus-list'])
                                            ...
                                            @can('syllabus-list')
                                                <li class="nav-item"><a href="{{ route('syllabus.index') }}" class="nav-link">
                                                    {{ __('syllabus') }} </a>
                                                </li>
                                            @endcan
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="student-menu">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        @canany('transfer-student-create')
                                            <li class="nav-item"><a href="{{ route('transfer-student.index') }}"
                                                    class="nav-link text-wrap">{{ __('Transfer Student') }}</a>
                                            </li>
                                        @endcan

                                        @canany('promote-student-create')
                                            <li class="nav-item"><a href="{{ route('promote-student.index') }}"
                                                    class="nav-link text-wrap">{{ __('Promote Students') }}</a>
                                            </li>
                                        @endcan
                            ...
                            <li class="nav-item">
                                @can('holiday-list')
                                    <a href="{{ route('holiday.index') }}" class="nav-link"
                                        ...
                                        <i class="fa fa-umbrella-beach menu-icon"></i>
                        ...
                        @canany(['gallery-create', 'gallery-list', 'gallery-edit', 'gallery-delete'])
                            <li class="nav-item">
                                <a href="{{ route('gallery.index') }}" class="nav-link"
                                    ...
                                    <i class="fa fa-photo-film menu-icon"></i>
        ...
        @php
            ...
            $personnelPermissions = [
                ...
                'task-list', 'task-create', 'task-edit', 'task-delete', 'task-assign'
            ];
                        ...
                        @canany(['package-list', 'package-create', 'package-edit', 'package-delete'])
                            <li class="nav-item">
                                <a href="{{ route('package.index') }}" class="nav-link">
                                    <i class="fa fa-box-archive menu-icon"></i>
                ...
                <div class="collapse" id="certificate-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @canany(['certificate-list'])
                            ...
                            <li class="nav-item">
                                <a href="{{ url('certificate-assign') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
                                    <i class="fa fa-trophy menu-icon"></i>
                                    <span class="menu-title">{{ __('certificate_assign') }}</span>
                                </a>
                            </li>
                        ...
                        {{-- My certificate (Staff & Teacher only) --}}
                        @if (Auth::user() && !Auth::user()->hasRole('School Admin'))
                            <li class="nav-item">
                                <a href="{{ route('staff.my-certificate') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
                                    <i class="fa fa-trophy menu-icon"></i>
                                    <span class="menu-title">{{ __('my_certificates') }}</span>
                                </a>
                            </li>
                        @endif
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="reports-menu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @if(Auth::user() && Auth::user()->HasRole('School Admin'))
                                <li class="nav-item">
                                    <a href="{{ route('reports.staff.staff-reports') }}" class="nav-link">
                                        <i class="fa fa-users-gear menu-icon"></i>
                                        <span class="menu-title">{{ __('staff_reports') }}</span>
                                    </a>
                                </li>
                            @endif
                            @can('reports-exam')
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="settings-group">
                    <ul class="nav flex-column sub-menu">
                                ...
                                <div class="collapse" id="settings-menu">
                                    <ul class="nav flex-column sub-menu">
                                        @can('app-settings')
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="{{ route('system-settings.app') }}">{{ __('web_app_settings') }}</a>
                                            </li>
                                        @endcan
                                        ...
                                        @canany(['school-custom-field-list', 'school-custom-field-create', 'school-custom-field-edit',
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="{{ route('schools.custom-field.index') }}">{{ __('school_additional_fields') }}</a>
                                            </li>
                                        @endcanany
                                        ...
                                        @role('Super Admin')
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('system-settings.health') }}">{{ __('health') }}</a>
                                            </li>
                                        @endrole
                        ...
                        @canany(['academy-setup-create', 'academy-setup-list', 'academy-setup-edit', 'academy-setup-delete'])
                            
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('academy-setup.index') }}">
                                    <i class="fa fa-bank menu-icon"></i>
                                    <span class="menu-title">{{ __('academy_setup') }}</span>
                                </a>
                            </li>
        ...
        @canany(['contact-inquiry-list'])
            <li class="nav-item">
                <a href="{{ url('contact-inquiry') }}" class="nav-link">
                    <i class="fa fa-envelopes-bulk menu-icon"></i>
