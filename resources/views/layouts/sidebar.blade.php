...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        {{-- student diary --}}
        {{-- @can(['student-diary-list', 'student-diary-create', 'student-diary-edit', 'student-diary-delete'])
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="exam-menu">
                    <ul class="nav flex-column sub-menu">
                        @can('exam-create')
                            <li class="nav-item">
                                <a href="{{ route('exams.index') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')"> {{ __('manage_exam') }}
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('view-exam-marks')
                            <li class="nav-item">
                                <a href="{{ route('exam.view-marks') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')"> {{ __('track_exam_marks') }}
                                </a>
                            </li>
                        @endcan
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="online-exam-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('online-exam-create')
                            <li class="nav-item">
                                <a href="{{ route('online-exam-question.add-bulk-questions') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')"> {{ __('add_bulk_questions') }}
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="fees-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('fees-paid')
                            <li class="nav-item">
                                <a href="{{ route('fees.optional') }}" class="nav-link" data-access="@hasFeatureAccess('Fees Management')"> {{ __('Optional Fee') }}</a>
                            </li>
                        @endcan
                        @can('fees-paid')
                            <li class="nav-item">
                        ...
                        @can('fees-paid')
                            <li class="nav-item">
                                <a href="{{ route('fees.report.index') }}" class="nav-link" data-access="@hasFeatureAccess('Fees Management')"> {{__('Fees Report') }}
                                </a>
                            </li>
                        @endcan
