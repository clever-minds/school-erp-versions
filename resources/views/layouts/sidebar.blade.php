    ...
    <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="academics-menu">
                    <ul class="nav flex-column sub-menu">
                        @can('medium-create')
                            <li class="nav-item">
                                <a href="{{ route('mediums.index') }}" class="nav-link"> {{ __('medium') }} </a>
                            </li>
                        @endcan
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('class-section.index') }}">
                <span class="menu-title"> {{ __('Class Section') }} </span><i class="fa fa-university menu-icon"></i> </a>
        </li>
        @endrole
        ...
        @canany(['exam-create', 'exam-upload-marks', 'grade-create', 'exam-result', 'online-exam-result-list'])
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#exam-menu" aria-expanded="false"
                   aria-controls="exam-menu" data-access="@hasFeatureAccess('Exam Management')">
                    <span class="menu-title">{{ __('Exam & Result') }}</span>
                ...
                <div class="collapse" id="exam-menu">
                    <ul class="nav flex-column sub-menu">
                        @can('exam-create')
                            <li class="nav-item">
                                <a href="{{ route('exams.index') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')"> {{ __('Manage Offline Exam') }}
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('online-exam-result-list')
                            <li class="nav-item">
                                <a href="{{ route('online-exam.index') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')">
                                    {{ __('online_exam_result') }}
                                </a>
                            </li>
                        @endcan
        ...
        {{-- @canany(['leave-list', 'leave-create', 'leave-edit', 'leave-delete'])
            <li class="nav-item">
                <a href="{{ route('leave.index') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Staff Leave Management')"> <span class="menu-title">{{ __('leave') }}</span> <i class="fa fa-briefcase menu-icon"></i> </a>
            </li>
        @endcanany

        @can('approve-leave')
            <li class="nav-item">
                <a href="{{ route('leave.request') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Staff Leave Management')"> <span class="menu-title">{{ __('leave') }}</span> <i class="fa fa-briefcase menu-icon"></i> </a>
            </li>
        @endcan --}}
        ...
        @canany(['faqs-create','faqs-list','faqs-edit','faqs-delete'])
            <li class="nav-item">
                <a href="{{ route('faqs.index') }}" class="nav-link"> <span
                        class="menu-title">{{ __('faqs') }}</span> <i class="fa fa-question menu-icon"></i>
                </a>
            </li>
        @endcanany
        ...
        @canany(['app-settings', 'language-list', 'school-setting-manage', 'system-setting-manage',
            'fcm-setting-manage', 'email-setting-create', 'privacy-policy', 'contact-us', 'about-us', 'role-create'])
            <li class="nav-item">
                ...
                <div class="collapse" id="settings-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('front-site-setting')
                            <li class="nav-item">
                                <a class="nav-link"
                                   href="{{ route('system-settings.front-site-settings') }}">{{ __('front_site_settings') }}</a>
                            </li>
                        @endcan
                        ...
                        @role('Super Admin')
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('system-settings.payment.index') }}">{{ __('payment_configuration') }}</a>
                        </li>
                        @endrole
                        @can('privacy-policy')
                            <li class="nav-item">
