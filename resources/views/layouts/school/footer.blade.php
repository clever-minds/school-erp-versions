                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 infoDivWrapper">
                        ...
                        <div class="textDiv">
                            ...
                            <span><a class="footer-contact"
                                    href="mailto:{{ $schoolSettings['school_email'] ?? '' }}">{{ $schoolSettings['school_email'] ?? '' }}</a></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 infoDivWrapper">
                        ...
                        <div class="textDiv">
                            ...
                            <span><a class="footer-contact"
                                    href="tel:+{{ $schoolSettings['school_phone'] ?? '' }}">{{ $schoolSettings['school_phone'] ?? '' }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="linksWrapper">
                    ...
                    <span>
                        @if(isset($systemSettings['student_web_url']) && !empty($systemSettings['student_web_url']))
                            <a href="{{ rtrim($systemSettings['student_web_url'], '/') }}/student/auth/{{ $school->code }}"
                                target="_blank">{{ __('student_login') }}</a>
                        @else
                            <a href="{{ url('login') }}">{{ __('student_login') }}</a>
                        @endif
                    </span>
                    <span>
