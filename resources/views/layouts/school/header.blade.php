<style>
    .loginWrapper .dropdown button[data-bs-toggle="dropdown"]::after {
            ...
            <div class="loginWrapper">
                ...
                @if(isset($systemSettings['student_web_url']) && !empty($systemSettings['student_web_url']))
                    <div class="dropdown" style="display: inline-block;">
                        <button class="commonBtn" data-bs-toggle="dropdown" aria-expanded="false">{{ __('login') }}<i
                                class="fa-regular fa-user ps-2"></i></button>
                        <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;">
                            <li>
                                <a class="dropdown-item login-redirect" href="#" data-type="staff">
                                    <i class="fa-solid fa-user-tie me-2"></i> {{ __('Login with Staff') }}
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item"
                                    href="{{ rtrim($systemSettings['student_web_url'], '/') }}/student/auth/{{ $school->code }}"
                                    target="_blank">
                                    <i class="fa-solid fa-user-graduate me-2"></i> {{ __('Login with Student') }}
                                </a>
                            </li>
                        </ul>
                    </div>
                @else
                    <a href="{{ url('login') }}" class="commonBtn">
                        {{ __('login') }}<i class="fa-regular fa-user ps-2"></i>
                    </a>
                @endif
            </div>
        </div>
            ...
            <div class="offcanvas-body">
                <ul class="listItems">
                    ...
                    <div class="loginWrapper">
                        ...
                        @if(isset($systemSettings['student_web_url']) && !empty($systemSettings['student_web_url']))
                            <div class="dropdown" style="display: inline-block;">
                                <button class="commonBtn" data-bs-toggle="dropdown"
                                    aria-expanded="false">{{ __('login') }}<i class="fa-regular fa-user ps-2"></i></button>
                                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;">
                                    <li>
                                        <a class="dropdown-item login-redirect" href="#" data-type="staff">
                                            <i class="fa-solid fa-user-tie me-2"></i> {{ __('Login with Staff') }}
