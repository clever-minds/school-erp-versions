    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        @if (isset($systemSettings['email_verified']) && !$systemSettings['email_verified'])
            @can('email-setting-create')
                <div class="m-auto order-0 d-none d-md-block">
                    <div class="badge badge-danger my-2" role="alert">
        ...
        @if (Auth::user() && !Auth::user()->school_id && isset($systemSettings['web_maintenance']) && $systemSettings['web_maintenance'] == 1)
            <div class="m-auto order-0 d-none d-md-block">
                <div class="badge badge-danger my-2" role="alert">
                    <i class="fa fa-exclamation"></i>
                    {{ __('the_system_is_currently_in_maintenance_mode') }}
                </div>
            </div>
        @endif
                ...
                <li class="nav-item dropdown d-none d-md-block d-sm-block">
                    <a class="nav-link dropdown-toggle" href="#" id="sessionYearDropdown"
                        ...
                        @if($sessionYear->id == $defaultSessionYear->id)
                            <div class="px-2 py-1 font-weight-bold badge-pill-custom badge badge-success p-2">
                                {{ $sessionYear->name }}
                            </div>
                        @else
                            <div class="px-2 py-1 font-weight-bold badge-pill-custom badge badge-warning p-2">
                                {{ $sessionYear->name }}
                            </div>
                        @endif
                    ...
                    <li class="nav-item dropdown d-none d-md-block d-sm-block">
                        <a class="nav-link dropdown-toggle" href="#" id="semesterDropdown"
                            ...
                            @if (isset($semester) && $semester->id)
                                <div class="px-2 py-1 font-weight-bold badge badge-info p-2">
                                    {{ $semester->name }}
                                </div>
                            @else
                                <div class="px-2 py-1 font-weight-bold badge badge-warning p-2">
                                    {{ __('Select Semester') }}
                                </div>
                            @endif
                        </a>
