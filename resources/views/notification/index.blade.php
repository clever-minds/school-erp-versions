                        ...
                        <form id="create-form" class="pt-3" action="{{ url('notifications') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                 ...
                                 <div class="form-group col-sm-12 col-md-12">
                                    <label for="">{{ __('Event Date') }} <span class="text-danger">*</span></label>
                                    {!! Form::text('event_date', null, ['class' => 'form-control datepicker','placeholder' => __('Event Date'), 'rows' => 3]) !!}
                                </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.js"></script>
 ...
 function toggleEventDate() {
        var selectedType = $('input[name="type"]:checked').val();
        var eventDateField = $('input[name="event_date"]').closest('.form-group');

        if (selectedType === 'OverDueFees') {
            eventDateField.hide();
        } else {
            eventDateField.show();
        }
