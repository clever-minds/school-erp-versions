                                ...
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="user.full_name" data-sortable="false" data-formatter="StudentNameFormatter"> {{ __('student') }}</th>
                                            <th scope="col" data-field="status" data-formatter="assignElectiveSubjectStatusFormatter"> {{ __('status') }}</th>
                                            <th scope="col" data-field="elective_subjects" data-formatter="assignElectiveSubjectsFormatter"> {{ __('selected_subjects') }}</th>
                                            <th scope="col" data-field="operate" data-events="assignElectiveSubjectEvents" data-formatter="actionColumnFormatter"> {{ __('action') }}</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
                ...
                if (classId) {
                    ...
                    if (classData && classData.elective_subject_groups && classData.elective_subject_groups
                        ...
                        classData.elective_subject_groups.forEach(function(group) {
                            if (sessionYearId && group.session_year_id && parseInt(group.session_year_id) !== parseInt(sessionYearId)) {
                                return;
                            }
            ...
            // Handle session year change - removed because it relies on the header session year selector now
        ...
        function openAssignElectiveSubjectModal(rowData, sessionYearId, classSectionId) {
            ...
            if (classData && classData.elective_subject_groups) {
                ...
                groupsData = classData.elective_subject_groups.filter(function(g) {
                    return parseInt(g.session_year_id) === parseInt(sessionYearId);
                });
                ...
                groupsData = rowData.class_section.class.elective_subject_groups.filter(function(g) {
                    return parseInt(g.session_year_id) === parseInt(sessionYearId);
                });
