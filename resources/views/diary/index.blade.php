...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-5 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            {{ __('create_diary') }}
                        ...
                        <form class="create-form" data-success-function="formSuccessFunction" action="{{ route('diary.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="{{ __('Write Something...') }}"></textarea>
                                </div>
        ...
        $(document).on('change', '#filter_class_section_id', function () {
            ...
            if (current_user) {
                ...
                if (isClassTeacher) {
                    ...
                    selectedSection.subject_teachers.forEach(st => {
                        filteredSubjects.push(st.subject);
                    });
                } else {
                    // ✅ Otherwise → show only subjects assigned to this teacher
                    selectedSection.subject_teachers.forEach(st => {
                        if (st.teacher_id == current_user) {
                            filteredSubjects.push(st.subject);
                        }
                    });
                }
