                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                               ...
                               data-detail-filter="subjectTeachersDetailFilter" data-detail-view="true" data-detail-formatter="SubjectTeachersDetailFormatter" data-query-params="classQueryParams">
                            <thead>
                            <tr>
                                <th scope="col" data-field="id" data-sortable="true" data-visible="false">{{ __('id') }}</th>
                                <th scope="col" data-field="no">{{ __('no.') }}</th>
                                <th scope="col" data-field="full_name">{{ __('class') }}</th>
                                <th scope="col" data-field="class_teachers_list" data-formatter="listFormatter">{{ __('Class Teacher') }}</th>
                                <th scope="col" data-field="subject_teachers_list" data-formatter="listFormatter">{{ __('Subject Teacher') }}</th>
