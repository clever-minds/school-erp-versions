                    ...
                    <div class="card-body">
                        @if(!isset($settings['school_inquiry']) || $settings['school_inquiry'] != 1)
                            <div class="alert alert-danger">
                                {{ __('school_inquiry_is_disabled') }}
                                
                                <a href="{{ route('system-settings.index') }}" class="btn btn-sm btn-link">{{ __('enable_school_inquiry') }}</a>
                            </div>
                        @endif

                        <div class="{{ !isset($settings['school_inquiry']) || $settings['school_inquiry'] != 1 ? 'd-none' : '' }}">
                            <h4 class="card-title">
                                {{ __('list_schools_inquiry') }}
                            </h4>
                            ...
                            <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                data-url="{{ route('inquiry.list', 1) }}" data-click-to-select="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="school_phone">{{__('school_phone')}}</th>
                                        <th scope="col" data-field="school_email">{{ __('school_email') }}</th>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="create-form" class="pt-3 school-registration-form" action="{{ route('inquiry.update') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control school_code_prefix" id="school_code_prefix"
                                        name="school_code_prefix" required placeholder="{{ __('prefix') }}"
                                        value="{{ $prefix }}">
                                    <div class="input-group-append">
                                        <input type="text" class="input-group-text text-body school_code" id="basic-addon2"
                                            name="school_code" value="{{ $school_code }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
