                            ...
                            <div class="bg-light p-4 mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="file" required name="school_image" id="school_image" class="file-upload-default"/>
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" disabled="" placeholder="{{ __('logo') }}" required/>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="school_support_email">{{ __('support').' '.__('email') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="school_support_phone">{{ __('support').' '.__('phone') }} <span class="text-danger">*</span></label>
            ...
            <div class="col-md-12 grid-margin stretch-card search-container">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table" data-url="{{ route('schools.show', 1) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{ "fileName": "{{__('online').' '.__('exam')}}-<?= date(' d-m-y') ?>" ,"ignoreColumn":["operate"]}' data-show-export="true" data-query-params="queryParams">
                            <thead>
                            <tr>
                                ...
                                <th scope="col" data-field="support_email">{{__('support').' '.__('email')}}</th>
                                <th scope="col" data-field="support_phone">{{__('support').' '.__('phone')}}</th>
                                ...
                                <th scope="col" data-field="operate" data-events="schoolEvents">{{ __('action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="edit-form" class="pt-3 edit-form" action="{{ url('schools') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_school_support_email">{{ __('support').' '.__('email') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="edit_school_support_phone">{{ __('support').' '.__('phone') }} <span class="text-danger">*</span></label>
                ...
                <form id="admin-form-modal" class="edit-form change-school-admin" action="{{ url('schools/admin/update') }}" data-success-function="successFunction" method="post" novalidate>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12">
                            ...
                            <select class="edit-school-admin-search w-100 form-control"></select>
                            <input type="hidden" id="edit_admin_email" name="edit_admin_email">
                        </div>

                        <div class="form-group col-sm-12 col-md-6">
                            <label>{{ __('admin') . ' ' . __('first_name') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <label>{{ __('admin') . ' ' . __('last_name') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <label>{{ __('admin') . ' ' . __('contact') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="text" class="form-control file-upload-info" disabled="" placeholder="{{ __('admin') . ' ' . __('image') }}"/>
                                <span class="input-group-append">
