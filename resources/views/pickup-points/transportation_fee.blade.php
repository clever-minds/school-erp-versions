                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 transportation-fee-create-form" id="create-form"
                            ...
                            action="{{ route('pickup-points.transportation-fees.update') }}" method="POST"
                            novalidate="novalidate">
                            @csrf
                            <input type="hidden" name="pickup_point_id" value="{{ $transportationFees->id }}">
                            <div class="row">
                                <div class="form-group col-sm-6 col-md-6">
                                    <label>{{ __('pickup_point') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="" class="form-control" required
                                        value="{{ $transportationFees->name }}" readonly>
                                </div>
