    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 col-tb-6 grid-margin stretch-card">
                <div class="card">
                    @if ($upcoming_package && $settings['auto_renewal_plan'])
                        <div class="card-body">
                                ...
                                <div class="form-group col-sm-12 col-md-12 table-responsive">
                                    <table class="table table-bordered" data-mobile-responsive="true">
                                        <tr>
                                            ...
                                            <th class="text-center">{{ __('charges') }} ({{ $settings['currency_symbol'] }})</th>
                                            <th class="text-center">{{ __('total_user') }}</th>
                                            <th class="text-center">{{ __('total_amount') }} ({{ $settings['currency_symbol'] }})</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                {{ number_format($data['students'] * $active_package->student_charge, 4) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="text-small text-muted mt-2">
                                                    {{ __('including_teachers_and_staffs') }}
                                                </div>
                                            </td>
                                            <td class="text-right">{{ $active_package->staff_charge }}</td>
                                            <td class="text-right">{{ $data['staffs'] }}</td>
                                            <td class="text-right">
                                                {{ number_format($data['staffs'] * $active_package->staff_charge, 4) }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th class="text-center" colspan="4">{{ __('addon') }}</th>
                                            <th class="text-center">{{ __('total_amount') }} ({{ $settings['currency_symbol'] }})</th>
                                        </tr>
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">
                                                {{ $settings['currency_symbol'] }}{{ number_format($total_addon_charges, 2) }}
                                            </th>
                                        </tr>
                                        <tr>
                                            <th colspan="4">{{ __('total_bill_amount') }} : </th>
                                            <th class="text-right">
                                                {{ $settings['currency_symbol'] }}{{ number_format($total_addon_charges + $total_user_charges, 2) }}
                                            </th>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            data-export-types='["txt","excel"]' data-query-params="subscriptionQueryParams"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="total_student" data-sortable="false">
                                        {{ __('total_students') }}</th>
                                    ...
                                    <th scope="col" data-field="payment_status"
                                        data-formatter="transactionPaymentStatus">{{ __('status') }}</th>
                                    <th scope="col" data-field="operate" data-events="subscriptionEvents">
                                        {{ __('action') }}</th>
                                </tr>
                            </thead>
                        </table>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th colspan="4" class="text-center">{{ __('addon') }}</th>
                                                        <th class="text-center">{{ __('total_amount') }} ({{ $settings['currency_symbol'] }})</th>
                                                    </tr>
