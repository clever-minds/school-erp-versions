...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                {{ __('manage_subscription') }}
            </h3>
            <nav aria-label="breadcrumb">
                <a href="{{ url('subscriptions/report/school', $subscriptionBill->school_id) }}" class="btn btn-sm btn-theme">{{ __('back') }}</a>
            </nav>
        </div>
        <div class="row">
                    ...
                    <div class="sub-card-body">
                        ...
                        {!! Form::model($subscriptionBill, [
                            ...
                            <div class="col-md-12 mt-3">
                                <h4>{{ __('subscription_bill_receive_payment') }}</h4>
                            </div>
...
@section('script')
    <script>
        ...
        function formSuccessFunction(response) {
            setTimeout(() => {
                window.location.href = "{{url('subscriptions/report/school/'.$subscriptionBill->school_id)}}"
            }, 2000);
        }
    </script>
@endsection