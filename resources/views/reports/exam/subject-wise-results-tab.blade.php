        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body px-0">
                    <div class="row mb-4">
                        {{-- Removed session year filter - using global session year from header --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStatistics() {
        ...
        fetch(`{{ route('reports.exam.subject-wise-result-statistics') }}?class_section_id=${classSectionId || ''}&subject_id=${''}`)
    ...
    $(document).on('change', '#filter_subject_wise_class_section_id, #filter_subject_wise_exam_id', function() {
        updateStatistics();
        refreshTableData();
    });
