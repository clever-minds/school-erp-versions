        ...
        <div class="tvr-header__meta">
            ...
            <div class="tvr-header__badges">
                ...
                <span class="tvr-header__room-badge">
                    ...
                    <span class="text-success">{{ $schoolSettings['currency_symbol'] ?? '$' }}{{ number_format($teacher->staff->salary, 0) }}</span>
                </span>
                @endif
            </div>
        </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="tvr-info-panel">
                        ...
                        <div class="row tvr-field align-items-start">
                            ...
                            <div class="col-7 tvr-field__value text-right">{{ $schoolSettings['currency_symbol'] ?? '$' }} {{ number_format($teacher->staff->salary ?? 0, 0) }}</div>
                        </div>
