                    ...
                    <div class="col-md-6 mb-3">
                        <div class="svr-info-panel">
                            ...
                            <div class="row svr-field align-items-start">
                                <div class="col-5 svr-field__label"><i class="fa fa-calendar-check-o me-2"> </i>{{ __('admission_date') }}</div>
                            ...
                            <div class="svr-divider my-3"></div>
