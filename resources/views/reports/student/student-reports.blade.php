                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list'
                                       data-toggle="table" data-url="{{ route('reports.student.student-reports.show') }}" data-click-to-select="true"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="guardian.full_name" data-visible="true" data-formatter="StudentGuardianNameFormatter">{{ __('guardian_name') }}</th>
