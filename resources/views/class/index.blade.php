                    ...
                    <div class="card-body">
                        ...
                        <form class="pt-3 class-create-form" id="create-form" action="{{ route('class.store') }}" method="POST" data-pre-submit-function="classValidation" data-success-function="successFunction" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <select name="stream_id[]" id="stream_id" class="form-control form-control select2-dropdown select2-hidden-accessible" tabindex="-1" aria-hidden="true" data-placeholder=" --- {{__("Select Stream")}} --- " multiple>
                                    <option></option>
                            ...
                            <div class="form-group" id="stream-wise-section-div" style="display: none;">
                                @foreach ($streams as $stream)
                                    <div id="{{$stream->name}}-section-div" style="display: none;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                               ...
                               data-show-export="true" data-detail-view="true" data-detail-formatter="classSubjectsDetailFormatter" data-query-params="classQueryParams">
                            <thead>
                            <tr>
