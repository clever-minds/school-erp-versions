                    ...
                    <div class="card-body">
                        ...
                        <form class="pt-3 class-create-form" id="create-form" action="{{ route('class.store') }}" method="POST" data-pre-submit-function="classValidation" data-success-function="successFunction" novalidate="novalidate">
                            <div class="row">
                                        ...
                                        @foreach ($mediums as $medium)
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" {{ $loop->first ? 'checked' : '' }} name="medium_id" id="medium_{{ $medium->id }}" value="{{ $medium->id }}" required="required">
                                                    {{ $medium->name }}
                                                </label>
                                            </div>
                                        @endforeach
                                ...
                                <div class="form-group col-sm-12 col-md-12" id="default-section-div">
                                ...
                                <div class="form-group col-sm-12 col-md-12" id="stream-wise-section-div" style="display: none;">
                                    @foreach ($streams as $stream)
