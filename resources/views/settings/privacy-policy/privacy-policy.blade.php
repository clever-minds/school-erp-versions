                        ...
                        <div class="tab-content" id="privacyPolicyTabsContent">
                            <div class="tab-pane fade show active py-4" id="general" role="tabpanel"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mb-3 mt-4">
                                        ...
                                        <a href="{{ route('public.privacy-policy.privacy-policy') }}" target="_blank" class="text-break text-overflow-any">
                                            {{ route('public.privacy-policy.privacy-policy') }}
                                        </a>
                                    </div>

                                    <form id="formdata" class="edit-form-without-reset"
                            ...
                            <div class="tab-pane fade py-4" id="teacher-staff" role="tabpanel"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mb-3 mt-4">
                                        {{ __('Public URL') }} : 
                                        <a href="{{ route('public.teacher-staff-privacy-policy') }}" target="_blank" class="text-break text-overflow-any">
                                            {{ route('public.teacher-staff-privacy-policy') }}
                                        </a>
                                    </div>
                            ...
                            <div class="tab-pane fade py-4" id="student-parent" role="tabpanel"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mb-3 mt-4">
                                        {{ __('Public URL') }} :
                                        <a href="{{ route('public.student-parent-privacy-policy') }}" target="_blank" class="text-break text-overflow-any">
                                            {{ route('public.student-parent-privacy-policy') }}
                                        </a>
                                    </div>
