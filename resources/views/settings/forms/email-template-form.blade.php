<div class="rounded-lg">
    ...
    <div class="row my-4 mx-1">
        ...
        <div class="col-12 mb-3">
            <input type="hidden" name="template" class="email-template-value" value="school-email-template">
            <ul class="nav nav-tabs email-template-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-value="school-email-template" href="javascript:void(0)" role="tab">
                        {{ __('school_register_email_template') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-value="school-reject-template" href="javascript:void(0)" role="tab">
                        {{ __('school_application_reject_email_template') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-value="school-inquiry-template" href="javascript:void(0)" role="tab">
