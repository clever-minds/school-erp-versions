                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" accept="application/json" disabled="" placeholder="{{ __('upload_file') }}"/>
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    <input class="form-check-input mt-0 mx-1" type="checkbox" value="1" name="rtl" aria-label="Checkbox for following text input">
                            ...
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    <tr>
                                        ...
                                        <th data-events="languageSettingsEvents" scope="col" data-field="operate">{{ __('action') }}</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info" disabled="" placeholder="{{ __('upload_file') }}"/>
                                    <span class="input-group-append">
                                        <button class="file-upload-browse btn btn-theme" type="button">{{ __('upload') }}</button>
                                    </span>
                                </div>
