                ...
                <div class="card">
                    <div class="card-body">
                        <form id="formdata" class="create-form-without-reset"
                            action="{{ route('system-settings.app.update') }}" novalidate="novalidate">
                            @csrf

                            {{-- Student/Guardian App Settings --}}
                            <div class="border p-3 rounded mb-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input name="app_link" id="app_link" value="{{ $settings['app_link'] ?? '' }}"
                                            type="url" placeholder="{{ __('app_link') }}" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="ios_app_link">{{ __('ios_app_link') }}</label>
                                        <input name="ios_app_link" id="ios_app_link"
                                            value="{{ $settings['ios_app_link'] ?? '' }}" type="url"
                                            placeholder="{{ __('ios_app_link') }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label for="app_version">{{ __('app_version') }}</label>
                                        <input name="app_version" id="app_version"
                                            value="{{ $settings['app_version'] ?? '' }}" type="text"
                                            placeholder="{{ __('app_version') }}" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label for="ios_app_version">{{ __('ios_app_version') }}</label>
                                        <input type="text" name="ios_app_version" id="ios_app_version"
                                        ...
                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input"
                                                    value="{{ $settings['force_app_update'] ?? 0 }}"
                            ...
                            {{-- Student Web Settings --}}
                            <div class="border p-3 rounded mb-4">
                                <h4 class="card-title mb-3">
                                    <i class="fa fa-globe mr-2"></i>
                                    {{ __('student_web_settings') }}
                                </h4>
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12 mb-0">
                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input"
                                                    value="{{ $settings['student_web_maintenance'] ?? 0 }}"
                                                    id="student_web_maintenance">{{ __('student_web_maintenance') }}
                                                <i class="input-helper"></i>
                                            </label>
                                        </div>
                                        <input type="hidden" name="student_web_maintenance"
                                            id="txt_student_web_maintenance">
                                    </div>
                                </div>
                            </div>

                            {{-- Teacher/Staff App Settings --}}
                            <div class="border p-3 rounded mb-4">
                                <h4 class="card-title mb-3">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="teacher_app_link">{{ __('app_link') }}</label>
                                        <input name="teacher_app_link" id="teacher_app_link"
                                            value="{{ $settings['teacher_app_link'] ?? '' }}" type="url"
                                            placeholder="{{ __('app_link') }}" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label for="teacher_ios_app_link">{{ __('ios_app_link') }}</label>
                                        <input name="teacher_ios_app_link" id="teacher_ios_app_link"
                                            value="{{ $settings['teacher_ios_app_link'] ?? '' }}" type="url"
                                            placeholder="{{ __('ios_app_link') }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label for="teacher_app_version">{{ __('app_version') }}</label>
                                        <input name="teacher_app_version" id="teacher_app_version"
                                            value="{{ $settings['teacher_app_version'] ?? '' }}" type="text"
                                            placeholder="{{ __('app_version') }}" class="form-control" />
                                    </div>
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label for="teacher_ios_app_version">{{ __('ios_app_version') }}</label>
                                        <input type="text" name="teacher_ios_app_version" id="teacher_ios_app_version"
                                            placeholder="{{ __('ios_app_version') }}" class="form-control"
                                            value="{{ $settings['teacher_ios_app_version'] ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label>{{ __('force_app_update') }}</label>
                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input"
                                                    value="{{ $settings['teacher_force_app_update'] ?? 0 }}"
                                                    id="teacher_force_app_update">{{ __('force_app_update') }}
                                                <i class="input-helper"></i>
                                            </label>
                                        </div>
                                        <input type="hidden" name="teacher_force_app_update"
                                            id="teacher_txt_force_app_update">
                                    </div>
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label>{{ __('app_maintenance') }}</label>
                                        <div class="form-check mt-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input"
                                                    value="{{ $settings['teacher_app_maintenance'] ?? 0 }}"
                            ...
                            <div class="text-right">
                                <input class="btn btn-secondary mr-2" type="reset" value="{{ __('reset') }}">
...
@section('js')
    <script>
        function app_setting() {
            ...
            let student_web_maintenance = $('#student_web_maintenance').val();
            if (student_web_maintenance == 1) {
                $('#student_web_maintenance').attr('checked', true);
                $('#student_web_maintenance').val(1);
                $('#txt_student_web_maintenance').val(1);
            } else {
                $('#student_web_maintenance').val(0);
                $('#txt_student_web_maintenance').val(0);
            }
        ...
        $(document).on('change', '#student_web_maintenance', function () {
            if ($('#student_web_maintenance').val() == 1) {
                $('#student_web_maintenance').val(0);
                $('#txt_student_web_maintenance').val(0);
            } else {
                $('#student_web_maintenance').val(1);
