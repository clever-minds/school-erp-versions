...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="server-config-wrapper row" style="padding: 0; background: transparent;">

            {{-- ── Left Main Panel ────────────────────────────── --}}
            <div class="server-config-main col-md-8">
            ...
            {{-- ── Right Sidebar ────────────────────────────────────────── --}}
            <div class="server-config-sidebar col-md-4">
