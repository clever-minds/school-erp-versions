            ...
            <div class="col-md-12 grid-margin stretch-card search-container">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 add-lesson-form" id="create-form" data-success-function="formSuccessFunction" action="{{ route('lesson.store') }}" method="POST" novalidate="novalidate">
                    ...
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="class_section_with_medium" data-sortable="true"> {{ __('class_section') }}</th>
                                <th scope="col" data-field="subject_with_name" data-sortable="true"> {{ __('subject') }}</th>
                                ...
                                <th scope="col" data-events="lessonEvents" data-field="operate">{{ __('action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
