                        ...
                        <form class="pt-3" id="create-form" action="{{ route('expense.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-3">
                                    ...
                                    <input name="amount" id="amount" type="number" min="0" placeholder="{{ __('Amount') }}"
                                        class="form-control" required />
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-3">
                                        <label for="edit_amount">{{ __('Amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input name="amount" id="edit_amount" type="number" min="0" placeholder="{{ __('Amount') }}"
                                            class="form-control" required />
                                    </div>
...
@section('js')
    <script>
        ...
        function setDatepickerLimits() {
            ...
            let sessionYear = sessionYearFullData;
        ...
        function setEditDatepickerLimits() {
            // Find the selected session year object
            let sessionYear = sessionYearFullData;
            if (!sessionYear) return;
