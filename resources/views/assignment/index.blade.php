                    ...
                    <div class="card-body">
                        ...
                        <form class="pt-3 add-assignment-form" id="create-form" action="{{ route('assignment.store') }}" method="POST" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="due_date" placeholder="{{ __('last_submission_date') }}" class='form-control'>
                    ...
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="instructions" data-sortable="true"> {{ __('instructions') }}</th>
                                <th scope="col" data-field="file" data-sortable="true" data-formatter="fileFormatter">{{ __('files') }}</th>
                                <th scope="col" data-field="class_section.full_name" data-sortable="true"> {{ __('Class Section') }}</th>
                                <th scope="col" data-field="class_subject.subject.name_with_type" data-sortable="true"> {{ __('subject') }}</th>
                                <th scope="col" data-field="due_date" data-sortable="true">{{ __('due_date') }}</th>
                                <th scope="col" data-field="points" data-sortable="true">{{ __('points') }}</th>
                                <th scope="col" data-field="resubmission" data-formatter="yesAndNoStatusFormatter" data-sortable="true">{{ __('resubmission') }}</th>
                                <th scope="col" data-field="extra_days_for_resubmission" data-sortable="true">{{ __('extra_days_for_resubmission') }}</th>
                                <th scope="col" data-field="created_by_teacher" data-sortable="true" data-visible="true">{{ __('created_by_teacher') }}</th>
                                <th scope="col" data-field="edited_by_teacher" data-sortable="true" data-visible="true">{{ __('edited_by_teacher') }}</th>
                                <th scope="col" data-field="session_year_id" data-sortable="true" data-visible="false">{{ __('session_year_id') }}</th>
                                <th scope="col" data-field="created_at" data-sortable="true" data-visible="false"> {{ __('created_at') }}</th>
                                <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false"> {{ __('updated_at') }}</th>
                                <th scope="col" data-field="operate" data-events="assignmentEvents">{{ __('action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
