    ...
    <div class="content-wrapper">
        ...
        <div class="row">
                            ...
                            <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                                ...
                                <div class="col-12 row">
                                    <div class="form-group col-sm-12 col-md-6 col-lg-3">
                                        ...
                                        {{ Form::text('due_date', null, ['class' => 'datepicker-popup form-control', 'placeholder' => __('due_date'), 'required', 'autocomplete' => 'off']) }}
                                    </div>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('List Fees')}}</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    data-maintain-selected="true" data-export-data-type='all' data-query-params="feesQueryParams"
                                    data-toolbar="#toolbar"
                                    data-export-options='{ "fileName": "fees-list-<?= date('d-m-y') ?>" ,"ignoreColumn":["operate"]}'
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="due_charges" data-align="center">{{__('due_charges')}} (%)</th>
