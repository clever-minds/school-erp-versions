                ...
                <form class="create-form form-validation" method="post" action="{{ route('fees.compulsory.store') }}"
                    ...
                    @php
                        ...
                        if ($student->fees_paid && count($student->fees_paid->compulsory_fee)) {
                            $total_paid = $student->fees_paid->amount;
                    ...
                    @if (!$fees->include_fee_installments)
                        @php
                            ...
                            $card_badge_style = 'background-color: #e2e3e5; color: #41464b;';

                            if ($global_balance <= 0) {
                                $card_status_label = __('PAID');
                                $card_badge_class = 'badge-success';
                                $card_badge_style = 'background-color: #d1e7dd; color: #0f5132;';
                            } elseif ($total_paid > 0) {
                                $card_status_label = __('PARTIAL');
                                $card_badge_class = 'badge-warning';
                                $card_badge_style = 'background-color: #fff3cd; color: #664d03;';
                            }
                        @endphp
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-center border-left border-right">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <span class="badge"
                                                style="padding: 5px 15px; font-weight: 700; font-size: 0.75rem; border-radius: 50px; {{ $card_badge_style }}">
                                                {{ $card_status_label }}
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        @foreach ($fees->installments as $key => $installment)
                            @php
                                ...
                                $badge_style =
                                    'padding: 5px 15px; font-weight: 700; font-size: 0.75rem; border-radius: 50px;';
                                ...
                                if ($status == 1) {
                                    ...
                                    $opacity = '1';
                                    $badge_class = 'badge-success-custom'; // Fallback or inline
                                    // Specific Colors
                                    $badge_inline = 'background-color: #d1e7dd; color: #0f5132;';
                                } elseif ($status == 2) {
                                    // Partial
                                    ...
                                    $opacity = '1';
                                    $badge_inline = 'background-color: #fff3cd; color: #664d03;';
                                } else {
                                    // Unpaid
                                    ...
                                    $opacity = '1';
                                    $badge_inline = 'background-color: #e2e3e5; color: #41464b;';
                                    ...
                                    if ($is_overdue_item) {
                                        ...
                                        $badge_inline = 'background-color: #f8d7da; color: #842029;';
                                        ...
                                        $badge_inline = 'background-color: #cfe2ff; color: #084298;';
                                    } else {
                                    ...
                                    <div class="card-body py-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-3 text-center">
                                                <span class="badge"
                                                    style="{{ $badge_style }} {{ $badge_inline }}">{{ $status_label }}</span>
                                            </div>
                                            <div class="col-md-5">
                    ...
                    @if ($global_balance > 0)
                        <div class="card fixed-bottom-action border-primary pb-5 mb-4"
