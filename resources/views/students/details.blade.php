                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    data-url="{{ route('students.show', [1]) }}" data-click-to-select="true"
                                    ...
                                    data-query-params="studentDetailsQueryParams" data-export-data-type="all"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="user.id" data-visible="false">{{ __('User Id') }}
                                            </th>
                                            <th scope="col" data-field="user.full_name"
                                                data-formatter="StudentNameFormatter">{{ __('name') }}</th>
                                            <th scope="col" data-field="user.dob">{{ __('dob') }}</th>
                                            <th scope="col" data-field="class_section.full_name">{{ __('class_section') }}
                                            </th>
                                            ...
                                            <th scope="col" data-field="guardian_data"
                                                data-formatter="StudentGuardianNameFormatter">
                                            ...
                                            @canany(['student-edit', 'student-delete'])
                                                <th data-events="studentEvents" class="text-center" scope="col"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                    ...
                                    <select required name="class_section_id" class="form-control"
                                            ...
                                            <div class='form-group col-md-12 col-lg-6 col-xl-4 col-sm-12'>
                                                ...
                                                @elseif($data->type == 'radio')
                                                    <label class="d-block">{{$data->name}} @if($data->is_required)
                                                        <span class="text-danger">*</span>
                                                    @endif</label>
                                                    <div class="row form-check-inline ml-1 align-items-start">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                ...
                                                {{-- <input type="radio" name="guardian_gender" value="male"
                                                    id="edit_guardian_male" disabled> --}}
                                                {{ __('male') }}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                ...
                                                {{-- <input type="radio" name="guardian_gender" value="female"
                                                    id="edit_guardian_female" disabled> --}}
                                                {{ __('female') }}
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-4">
                                    <div class="d-flex">
                                        <div class="form-check w-fit-content">
                                            <label class="form-check-label ml-4">
                                                <input type="checkbox" class="form-check-input" name="parent_reset_password"
                                                    value="1">{{ __('reset_password') }}
                                            </label>
                                        </div>
                                    </div>
