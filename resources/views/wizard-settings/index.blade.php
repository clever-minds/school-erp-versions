    ...
    <div class="wizard-card-body">
        ...
        <div class="wizard-content-area">
            ...
            <div id="step-4" class="step-form {{ $currentStep == 4 ? 'active' : '' }}">
                ...
                <form id="form-email-template-settings" class="edit-form-without-reset"
...
@section('js')
    <script>
        ...
        $(document).on('click', '.email-template-tabs .nav-link', function(e) {
            ...
            let allTemplates = ['school-email-template', 'school-reject-template', 'school-inquiry-template'];
            allTemplates.forEach(function(tpl) {
                if (tpl === type) {
                    $('.' + tpl).show(500);
                    $('.' + tpl + ' :input[data-required]').prop('required', true);
                } else {
                    $('.' + tpl).hide(500);
                    $('.' + tpl + ' :input').prop('required', false);
                }
            });
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            function initializeWizard() {
                ...
                // Trigger initial template tab click if exists
                if ($('.email-template-tabs .nav-link.active').length) {
                    $('.email-template-tabs .nav-link.active').trigger('click');
                }
            }
