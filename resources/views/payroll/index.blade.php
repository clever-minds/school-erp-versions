                            ...
                            <div class="staff-table">
                                ...
                                <table aria-describedby="mydesc" class='table' id='table_list'
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="text-wrap" data-field="paid_leaves" data-sortable="false">{{ __('total_paid_leaves_per_month') }}</th>
                                        <th scope="col" class="text-wrap" data-field="total_leaves" data-sortable="false">{{ __('total_leaves') }}</th>
