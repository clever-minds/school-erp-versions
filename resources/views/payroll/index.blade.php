                        ...
                        <div class="card-body">
                            ...
                            <div class="staff-table">
                                ...
                                <table aria-describedby="mydesc" class='table table-striped' id='table_list'
                                    ...
                                    data-export-types='["txt","excel"]' data-query-params="payrollQueryParams"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-formatter="salaryStatusFormatter" data-field="status">
                                                {{ __('status') }}</th>
                                            <th scope="col" data-field="salary" data-formatter="salaryInputFormatter"
                                                data-sortable="false">{{ __('Amount') }}</th>
                                        </tr>
                                    </thead>
                                </table>
