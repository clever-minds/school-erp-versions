                                    ...
                                    <div class="row option-section" data-repeater-item>
                                        ...
                                        <div class="form-group col-md-1 pl-0 mt-4">
                                            <button data-repeater-delete type="button"
                                                ...
                                                title="{{__('remove_option')}}" disabled>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            <button type="button" class="btn btn-secondary" id="preview-fields" data-toggle="modal"
                                data-target="#previewFieldModal">{{__('preview_form_fields')}}</button>
                        </div>
                        <div class="d-block">
                            <div class="">
                        ...
                        <table aria-describedby="mydesc" class='table reorder-table-row' id='table_list' data-toggle="table"
                            data-url="{{ route('schools.custom-field.list', 1) }}" data-click-to-select="true"
                        ...
                        <div class="mt-1 d-none d-md-block">
                            <button id="change-order-school-form-field" class="btn btn-theme"
                                style="display:none;">{{ __('update_rank') }}</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{__('preview_form_fields')}}</h5>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            @foreach ($data->default_values as $value)
                                                <div class="form-check mr-3">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input chkclass"
                                                            value="{{$value}}">{{ $value }}
                                                    </label>
                                                </div>
                                            @endforeach
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="pt-3 edit-form edit-common-validation-rules" action="{{ route('schools.custom-field.update', ['id' => 0]) }}"
    ...
    <script>
        ...
        $('#table_list').on('load-success.bs.table', function (e, data) {
            if (data && data.total > 1) {
                $('#change-order-school-form-field').show();
            } else {
                $('#change-order-school-form-field').hide();
            }
        });
