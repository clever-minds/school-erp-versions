                        ...
                        <form class="pt-3 mt-6 add-exam-form create-form" data-success-function="formSuccessFunction" method="POST" action="{{ url('exams') }}">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12 col-lg-4">
                                    ...
                                    <select name="class_id[]" required multiple id="class-id" class="class-id form-control select2-dropdown select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            data-query-params="examQueryParams">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="publish" data-sortable="true" data-formatter="yesAndNoStatusFormatter">{{ __('publish') }}</th>
                                    <th scope="col" data-field="created_at" data-sortable="true" data-visible="false">{{ __('created_at') }}</th>
                                    <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false">{{ __('updated_at') }}</th>
                                    <th scope="col" data-field="operate" data-events="examEvents">{{ __('action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
