                    ...
                    <div class="card-body">
                        <div class="row" id="toolbar">
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                                <label for="exam" class="filter-menu">{{__("Exam")}}</label>
                                <select name="exam" class="form-control result_exam" class="form-control">
                            ...
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table" data-url="{{ route('exams.show-result', 1) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{ "fileName": "exam-list-<?= date(' d-m-y') ?>" ,"ignoreColumn": ["operate"]}' data-show-export="true" data-detail-formatter="examListFormatter" data-query-params="getExamResult">
                                    ...
                                    <tr>
                                        ...
                                        @can('class-teacher')
                                            <th scope="col" data-field="operate" data-events="examResultEvents">{{ __('action') }}</th>
                                        @endcan
                                    </tr>
                                    </thead>
                                </table>
