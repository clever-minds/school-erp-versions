                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <form class="edit-form" data-success-function="formSuccessFunction" action="{{ route('exam.timetable.update',$exam->id) }}" method="POST">
                                <div class="row">
                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="class_subject_id" id="subject_id" class="form-control exam-subjects-options" required>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('body').on('focus', ".timetable-date", function () {
                var minDate = moment("{{ $currentSessionYear->start_date }}", 'YYYY-MM-DD').format('DD-MM-YYYY') ;
