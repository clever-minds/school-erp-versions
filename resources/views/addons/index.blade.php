                    ...
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list'
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="operate" data-events="addonEvents">{{__('action')}}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="">{{ __('price') }} <span class="text-danger">*</span></label>
                                        <input type="number" min="1" name="price" id="edit_price" class="form-control" placeholder="{{ __('price') }}" required>
                                    </div>
