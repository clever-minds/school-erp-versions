                                ...
                                <div class="col-md-6 col-xl-3 grid-margin stretch-card pricing-card">
                                    <div class="card border-primary ribbon  border pricing-card-body">
                                        <div class="text-center pricing-card-head mb-2 text-center">
                                            <h4>{{ $addon->name }}</h4>
                                            <p>{{ __('price') }} : {{ $settings['currency_symbol'] ?? null }} {{ number_format($addon->price, 2) }} / {{ __('month') }} </p>
                                        ...
                                        <div class="wrapper">
                                            <a href="#" data-id="{{ $addon->id }}" class="btn btn-outline-success add-addon btn-block">{{ __('Add') }}</a>
                                        </div>
