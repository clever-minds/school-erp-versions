                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="flex_column_start">
                                    ...
                                    <span class="commonDesc">
                                        {{ $settings['tag_line'] ?? null }}
                                    </span>
                                    <span class="commonText">
                                        {{ $settings['hero_description'] ?? null }}</span>
                                    <div class="d-flex">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="whyBestTextWrapper">
                        <p>{{ $settings['about_us_title'] ?? null }}</p>
                        <p>{{ $settings['about_us_heading'] ?? null }}</p>
                    </div>
                    <p class="whyBestPara">
                        {{ $settings['about_us_description'] ?? null }}
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 content">
                    ...
                    <div class="storeImgs">
                        ...
                        @if (isset($settings['student_web_url']) && $settings['student_web_url'])
                            <a href="{{ $settings['student_web_url'] ?? '#' }}" target="_blank" class="student-web-btn-link">
                                <div class="student-web-btn">
                                    <i class="fa-solid fa-graduation-cap"></i>
                                    <div class="student-web-text">
                                        <span class="large-text">Student Web</span>
                                    </div>
                                </div>
                            </a>
                        @endif
