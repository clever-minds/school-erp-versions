        ...
        <div class="container">
            <div class="navbarWrapper">
                ...
                <div class="loginBtnsWrapper">
                    ...
                    {{-- <button class="commonBtn" id="trialBtn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{
                        __('start_trial') }}</button>--}}
                                    ...
                                    <div class="pricingBox premium flex flex-col justify-between h-full">
                                        <div class="startUpWrapper flex flex-col h-full">
                                            ...
                                            <div class="textDiv">
                                                ...
                                                <span>
                                                    {{ $settings['currency_symbol'] ?? '$' }} {{
                                                    number_format($package->staff_charge, 2) }} {{ __('per_staff_charges')
                                                    }}
                                                </span>
                                                @endif
                                            ...
                                            <div class="listWrapper">
                                                ...
                                                @if (in_array($feature->id,
                                                $package->package_feature->pluck('feature_id')->toArray()))
                                                <span>
