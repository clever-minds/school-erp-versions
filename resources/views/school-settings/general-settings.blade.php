                    ...
                    <div class="card-body">
                        <form class="create-form-without-reset" action="{{ route('school-settings.store') }}" method="POST"
                            ...
                            <div class="border border-secondary rounded-lg mb-2">
                                <div class="row my-4 mx-1">
                                    ...
                                    <div class="form-group col-md-2 col-sm-12">
                                        ...
                                        <input name="dise_code" id="dise_code" value="{{ $settings['dise_code'] ?? '' }}"
                                            type="text" placeholder="{{ __('DISE Code') }}" class="form-control" />
                                    </div>
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <input name="latitude" id="latitude" value="{{ $settings['latitude'] ?? '' }}"
                                                type="text" placeholder="{{ __('latitude') }}" class="form-control" />
                                            <div class="input-group-append">
                                                <button class="btn btn-primary" type="button"
                                                    onclick="getCurrentLocation('latitude', 'longitude')"
                                                    title="{{ __('get_current_location') }}"><i
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <input name="longitude" id="longitude" value="{{ $settings['longitude'] ?? '' }}"
                                            type="text" placeholder="{{ __('longitude') }}" class="form-control" />
                                    </div>
                                ...
                                <div class="row my-4 mx-1">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        <label for="fees_remainder_duration">{{ __('fees_remainder_duration')}} <span
                                                class="text-danger">*</span> <span
                                                class="text-small text-info">{{ __('reminder_days_before_due') }}</span></label>
                                    ...
                                    <div class="form-group col-sm-12 col-md-4 defaultDomain" style="display: none">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control domain-pattern" name="domain"
                                                ...
                                                value="{{ ($domain_type == "default" && $settings['domain']) ? $settings['domain'] : "" }}">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4 customDomain" style="display: none">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control domain-pattern" name="domain"
                                                placeholder="{{ __('domain') }}" aria-label="Recipient's username"
                                                aria-describedby="basic-addon2" disabled
                                                value="{{ ($domain_type == "custom" && $settings['domain']) ? $settings['domain'] : "" }}">
                                        </div>
                                    </div>
                                    @if (!env('DEMO_MODE'))
                            ...
                            <div class="border border-secondary rounded-lg mb-3">
                                ...
                                {{-- Minus Balance Limit --}}
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="expense_negative_limit">{{__('Minus Balance Limit')}} <span
                                            class="text-muted">({{__('allowed negative balance')}})</span></label>
                                    <input name="expense_negative_limit" id="expense_negative_limit"
                                        value="{{ $settings['expense_negative_limit'] ?? 0 }}" type="number" min="0"
                                        step="0.01" placeholder="{{__('Enter minus limit')}}" class="form-control" />
                                </div>
                            </div>
