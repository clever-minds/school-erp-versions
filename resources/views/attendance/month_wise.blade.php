                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="form-group col-sm-12 col-md-3">
                                <label class="filter-menu">{{ __('Class') }} {{ __('section') }} <span
                                        class="text-danger">*</span></label>
                                <select required name="class_section_id" id="class_section_id" class="form-control select2"
                            ...
                            <div class="form-group col-sm-12 col-md-3">
                                <label for="month" class="filter-menu">{{ __('month') }} <span
                                        class="text-danger">*</span></label>
...
@section('script')
    ...
    <script>
        ...
        function generateDayColumns(month, year) {
            const daysInMonth = new Date(year, month, 0).getDate(); // Month is zero-indexed, so no need to subtract 1
            const columns = [];
