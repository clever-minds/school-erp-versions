...
@section('script')
    ...
    <script>
        $('body').on('focus', ".datepicker-popup", function () {
            ...
            let startdate = "{{ Carbon\Carbon::createFromFormat($originalDateFormat, $sessionYear->start_date)->format('d-m-Y') }}";
            let endDate = "{{ Carbon\Carbon::createFromFormat($originalDateFormat, $sessionYear->end_date)->format('d-m-Y') }}";
