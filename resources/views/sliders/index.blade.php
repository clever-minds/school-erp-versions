                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            data-export-options='{ "fileName": "slider-list-<?= date('d-m-y') ?>" ,"ignoreColumn":
                            ["operate"]}'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="image" data-sortable="true"
                                    ...
                                    <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false">
                                        {{ __('updated_at') }}</th>
                                    <th scope="col" data-field="operate" data-events="sliderEvents">{{ __('action') }}
                                    </th>
                                </tr>
                            </thead>
                        </table>
