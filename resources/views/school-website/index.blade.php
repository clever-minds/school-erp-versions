                                                        ...
                                                        <div class="announcementCardWrapper">
                                                            <div class="card open-modal">
                                                                ...
                                                                <div class="eventDateWrapper">
                                                                    <span
                                                                        class="date">{{ date('d', strtotime($item->created_at)) }}</span>
                                                                    <span
                                                                        class="month">{{ date('F', strtotime($item->created_at)) }}</span>
                                                                    <span
                                                                        class="d-none eventDate">{{ date('d F, Y', strtotime($item->created_at)) }}</span>
                                                                </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="cardBg">
                                    <div class="card">
                                        ...
                                        <div class="cardDetails">
                                            <span class="cardTitle">Total Users</span>
