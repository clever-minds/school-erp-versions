                            ...
                            <div class="row">
                                        ...
                                        @foreach ($mediums as $medium)
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" {{ $loop->first ? 'checked' : '' }} name="medium_id" id="medium_{{ $medium->id }}" value="{{ $medium->id }}">
                                                    {{ $medium->name }}
                                                </label>
                                            </div>
                                        @endforeach
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="type" id="theory" checked value="Theory">{{__("Theory")}}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                    ...
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="name" data-sortable="true" data-formatter="subjectNameFormatter">{{ __('name') }}</th>
                                ...
                                <th scope="col" data-field="operate" class="text-center"     data-events="subjectEvents" data-escape="false">{{ __('action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
