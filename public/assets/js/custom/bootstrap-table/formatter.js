...
function typeFormatter(value, row) {
    if (value == 1) {
        ...
        return '<div class="badge badge-success badge-pill">' + window.trans['all'] + '</div>'
    } else if (value == 4) {
...
function teacherTimetableDayFormatter(value) {
    let html = "<ol>";
    value.forEach(function (data) {
        html += "<li><b>" + data.class_section.full_name + " - " + data.title + " : </b><small>" + data.start_time + " - " + data.end_time + "</small></li>";
    })
    html += "</ol>";
    return html;
}
