...
$('#class-section-id').on('change', function () {
    ...
    // console.log("Class ID (data-class-id): ", classId);
    // console.log("Section ID (data-section-id): ", sectionId);
    ...
    if ($('#topic-lesson-id').length) {
        ...
        if ($('#topic-lesson-id').val()?.length || $('#topic-lesson-id')) {
            ...
            $('#topic-lesson-id').val("");
            // console.log('subject-id =>', $('#subject-id').val());
            // console.log('dsd', $(this).val(), '#topic-lesson-id =>', $('#topic-lesson-id').val());
