...
use App\Repositories\FeesClass\FeesClassRepository;
...
use App\Repositories\InstallmentFees\InstallmentFeesRepository;
...
class RepositoryServiceProvider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->bind(FeesClassInterface::class, FeesClassRepository::class);
        $this->app->bind(InstallmentFeesInterface::class, InstallmentFeesRepository::class);
