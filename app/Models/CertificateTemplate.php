...
class CertificateTemplate extends Model
{
    ...
    protected $fillable = ['name', 'certificate_type_id', 'page_layout', 'height', 'width', 'user_image_shape', 'image_size', 'background_image', 'signature', 'description', 'fields', 'style', 'type', 'school_id', 'session_year_id'];
