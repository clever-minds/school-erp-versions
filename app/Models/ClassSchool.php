...
class ClassSchool extends Model {
    ...
    public function sections() {
        return $this->belongsToMany(Section::class, 'class_sections', 'class_id', 'section_id')->withPivot('id')->wherePivot('deleted_at', null);
    }
...
//    }
    ...
    public function fees_class() {
        return $this->hasMany(FeesClass::class, 'class_id')->withTrashed();
    }
    ...
    public function scopeOwner($query) {
        ...
        if (Auth::user()->school_id) {
            ...
            if (Auth::user()->hasRole('Teacher')) {
                ...
                $classIDS = ClassSection::whereIn('id', $classSectionIDS)->pluck('id');
