        ...
        if (Auth::user()) {
            if (Auth::user()->school_id) {
                ...
                if (Auth::user()->hasRole('Teacher')) {
                    ...
                    $classSectionId = ClassTeacher::where(['teacher_id' => Auth::user()->id, 'session_year_id' => $sessionYearId])->pluck('class_section_id');
                    return $this->whereIn('class_section_id', $classSectionId)->where('session_year_id', $sessionYearId);
                }
