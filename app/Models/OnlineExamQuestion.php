    ...
    public function scopeOwner($query)
    {
        if (Auth::user()) {
            ...
            if(Auth::user()->hasRole('Teacher')){
                $subjectTeacherData = SubjectTeacher::where('teacher_id',Auth::user()->id)->pluck('class_subject_id')->toArray();
                ...
                return $query->whereHas('online_exam_question_commons', function ($query) use ($subjectTeacherData) {
                    $query->whereIn('class_subject_id', $subjectTeacherData);
