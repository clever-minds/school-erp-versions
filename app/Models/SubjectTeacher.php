    ...
    public function scopeOwner($query)
    {
        if (Auth::user()) {
            ...
            if (Auth::user()->hasRole('Teacher')) {
                ...
                $sessionYearId = $cache->getSessionYear()->id;
                ...
                return $query->whereIn('class_subject_id', $class_subject_ids)->where(['teacher_id' => Auth::user()->id, 'school_id' => Auth::user()->school_id, 'session_year_id' => $sessionYearId]);
            }
