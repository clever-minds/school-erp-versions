    ...
    public function getStatusAttribute() {
        ...
        if ($this->subscription_bill) {
            if ($this->subscription_bill->transaction) {
                if ($this->subscription_bill->transaction->payment_status == 1) {
                    return 2; // Paid
                }
                if ($this->subscription_bill->transaction->payment_status == 0) {
                    return 4; // Failed
                }
                if ($this->subscription_bill->transaction->payment_status == 2) {
                    return 5; // Pending
                }
            } else {
