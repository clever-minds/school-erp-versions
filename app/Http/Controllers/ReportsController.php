...
class ReportsController extends Controller
{
    ...
    public function getStudentAttendanceReport(Request $request)
    {
        ...
        $startDate = Carbon::createFromDate($sessionYearStartDate, $request->month, 1)->startOfMonth();
        $endDate = Carbon::createFromDate($sessionYearEndDate, $request->month, 1)->endOfMonth();
    ...
    public function teacher_view_reports($id)
    {
        ...
        })->with('subject:id,name,bg_color', 'class_section.class', 'class_section.class.shift', 'class_section.section', 'class_section.medium')->get();
