...
class OnlineExamController extends Controller {
    ...
    public function __construct(ClassSectionInterface $classSection, SubjectTeacherInterface $subjectTeacher, OnlineExamInterface $onlineExam, OnlineExamQuestionChoiceInterface $onlineExamQuestionChoice, OnlineExamQuestionInterface $onlineExamQuestion, OnlineExamQuestionOptionInterface $onlineExamQuestionOption, OnlineExamStudentAnswerInterface $onlineExamStudentAnswer, CachingService $cachingService, StudentInterface $student, StudentOnlineExamStatusInterface $studentOnlineExamStatus) {
    ...
    public function index() {
        ...
        ResponseService::noAnyPermissionThenSendJson(['online-exam-list', 'online-exam-result-list']);
        ...
        return response(view('online_exam.index', compact('classSections', 'subjectTeachers')));
    }
    ...
    public function onlineExamResultIndex($id) {
        ResponseService::noFeatureThenRedirect('Exam Management');
        ResponseService::noAnyPermissionThenRedirect(['online-exam-list', 'online-exam-result-list']);
