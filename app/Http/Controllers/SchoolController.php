...
class SchoolController extends Controller {
    ...
    public function __construct(SchoolInterface $school, UserInterface $user) {
    ...
    public function update(Request $request, $id) {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'edit_school_support_phone' => 'required|numeric|digits:10',
...
//            dd("inside try block");
            $school_data = array(
                ...
                'logo'          => $request->file('edit_school_image')
            );
    ...
    public function updateAdmin(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
            ...
            "edit_admin_contact"    => 'required|digits:10',
        ]);
        if ($validator->fails()) {
            ResponseService::validationError($validator->errors()->first());
        }
    ...
    public function registration(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'admin_first_name'     => 'required',
            'admin_last_name'      => 'required',
            'admin_contact'        => 'required|numeric|digits:10',
