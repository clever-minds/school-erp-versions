...
class SectionController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            // Safety Check: Prevent deletion if section is assigned to any class in any session
            if (ClassSection::where('section_id', $id)->exists()) {
                return ResponseService::errorResponse("Cannot delete this section because it is assigned to one or more classes in academic sessions. Please remove it from all classes first.");
            }
    ...
    public function trash($id)
    {
        ResponseService::noPermissionThenSendJson('section-delete');
        try {
            // Safety Check: Prevent permanent deletion if section is assigned to any class in any session
            if (ClassSection::where('section_id', $id)->exists()) {
                return ResponseService::errorResponse("Cannot delete this section permanently because it is assigned to one or more classes in academic sessions. Please remove it from all classes first.");
            }
