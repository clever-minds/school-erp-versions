...
class GuardianController extends Controller
{
    ...
    public function __construct(UserInterface $user, ClassSchoolInterface $class, SectionInterface $section, ClassSectionInterface $classSection, CachingService $cache)
    {
        $this->user = $user;
        $this->class = $class;
    ...
    public function index()
    {
        ...
        $class_sections = $this->classSection->builder()->with('class', 'class.stream', 'class.shift', 'section', 'medium')->get();
    ...
    public function show(Request $request)
    {
        ...
        $sql = $this->user->guardian()->with('child.class_section.class', 'child.class_section.class.shift', 'child.class_section.section', 'child.class_section.medium')
            ->whereHas('child', function ($q) use ($sessionYear) {
