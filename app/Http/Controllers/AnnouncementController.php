...
class AnnouncementController extends Controller
{
    ...
    public function show()
    {
        ...
        $sql = $this->announcement->builder()->with('file', 'announcement_class.class_section.class.stream', 'announcement_class.class_section.class.shift', 'announcement_class.class_section.section', 'announcement_class.class_section.medium', 'announcement_class.class_subject.subject', 'session_years_trackings')
