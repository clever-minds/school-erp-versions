    ...
    public function show(Request $request)
    {
        ...
        foreach ($res as $row) {
            ...
            if ($request->show_deactive == 1) {
                ...
                $operate = BootstrapTableService::menuRestoreButton('restore', route('driver-helper.restore', $row->id), false);
                $operate .= BootstrapTableService::menuTrashButton('trash', route('driver-helper.trash', $row->id), 'you_want_to_delete_this_record');
            } else {
                //Show Edit and Soft Delete Buttons
                $operate = BootstrapTableService::menuEditButton('edit', route('driver-helper.update', $row->id));
                ...
                $operate .= BootstrapTableService::menuDeleteButton('delete', route('staff.destroy', $row->id));
            }
