...
class AttendanceController extends Controller {
    ...
    public function index() {
        ...
        $classSections = $this->classSection->builder()->ClassTeacher()->with('class', 'class.stream', 'section')->get();
...
//        $limit = $request->input('limit', 10);
        ...
        if ($date != '' && $attendanceQuery->count() > 0) {
            ...
            $studentQuery = $this->student->builder()->where('class_section_id', $class_section_id)->with('user')
