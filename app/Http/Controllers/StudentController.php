...
class StudentController extends Controller {
    ...
    public function __construct(StudentInterface $student, UserInterface $user, ClassSectionInterface $classSection, FormFieldsInterface $formFields, SessionYearInterface $sessionYear, CachingService $cachingService, FeaturesService $features) {
    ...
    public function show(Request $request) {
        ...
        $sql = $this->student->builder()->with('user.extra_student_details', 'guardian', 'class_section.class', 'class_section.section', 'class_section.medium')
    ...
    public function trash($id) {
        ResponseService::noFeatureThenRedirect('Student Management');
        ResponseService::noPermissionThenSendJson('student-delete');
        try {
