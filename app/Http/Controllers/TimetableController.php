...
class TimetableController extends Controller
{
    ...
    public function teacherList(Request $request)
    {
        ...
        $sql = $this->user->builder()->role('Teacher')->with([
            'timetable' => function ($query) {
                $query->CurrentSemesterData()->with('subject:id,name,type', 'class_section.class', 'class_section.class.shift', 'class_section.class.stream', 'class_section.medium', 'class_section.section');
            }
        ]);
        if (!empty($request->search)) {
            $search = $request->search;
    ...
    public function teacherShow($teacherID)
    {
        ...
        })->with('subject:id,name,type,bg_color', 'class_section.class', 'class_section.section', 'class_section.medium', 'class_section.class.stream', 'class_section.class.shift')->get();
