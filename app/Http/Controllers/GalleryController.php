...
class GalleryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        foreach ($res as $row) {
            ...
            $operate = BootstrapTableService::menuButton('view', route('gallery.edit', $row->id), [], ['title' => trans("view")]);
            $operate .= BootstrapTableService::menuEditButton('edit', route('gallery.edit', $row->id), true);
            $operate .= BootstrapTableService::menuDeleteButton('delete', route('gallery.destroy', $row->id));
