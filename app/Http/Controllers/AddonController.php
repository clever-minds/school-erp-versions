...
class AddonController extends Controller {
    ...
    public function plan() {
        ...
        $subscription = $this->subscription->default()->with('subscription_feature')->first();
        if ($subscription) {
            $subscription = $subscription->subscription_feature->pluck('feature_id')->toArray();
        } else {
            $subscription = array();
        }
        return view('addons.plan', compact('addons', 'settings','subscibed_addons','subscription'));
    }
