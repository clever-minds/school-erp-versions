...
class AssignmentController extends Controller
{
    ...
    public function assignmentSubmissionList()
    {
        ...
        $sql = $this->assignmentSubmission->builder()->with('assignment.class_subject.subject', 'student:first_name,last_name,id,image,email', 'file', 'session_year', 'assignment.class_section.class.stream', 'assignment.class_section.class.shift', 'assignment.class_section.medium', 'session_years_trackings')
            //search query
            ->when($search, function ($query) use ($search) {
                $query->where(function ($query) use ($search) {
                    $query->where('id', 'LIKE', "%$search%")
