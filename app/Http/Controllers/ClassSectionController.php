...
class ClassSectionController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $sql = $this->classSection->builder()->with(['class.stream', 'class.shift', 'section', 'medium', 'class_teachers.teacher', 'subject_teachers' => function ($q) {
            $q->with('teacher')
    ...
    public function edit($id)
    {
        ...
        $classSection = $this->classSection->findById($id, ['*'], ['class', 'class.stream', 'class.shift', 'section', 'medium', 'subjects', 'class_teachers']);
