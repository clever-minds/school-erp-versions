...
class ClassSectionController extends Controller {
    ...
    public function show(Request $request) {
        ...
        $sql = $this->classSection->builder()->with('class.stream', 'section', 'medium', 'class_teachers.teacher', 'subject_teachers.subject', 'subject_teachers.teacher', 'subject_teachers.semester:id,name');
