    ...
    public function payCompulsoryFeesStore(Request $request)
    {
        ...
        try {
            ...
            if ($user) {
                ...
                $body = "Your payment of ₹" . number_format($amount, 2) . " for " . $paymentType . " was successful.";
                $type = "payment";
    ...
    public function payOptionalFeesStore(Request $request)
    {
        ...
        try {
            ...
            if ($user) {
                ...
                $title = 'Fees Payment Successful';
                $body = "Your payment of ₹" . number_format($request->total_amount, 2) . " for " . $paymentType . " was successful.";
                $type = "payment";
