...
class MediumController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            //     ResponseService::errorResponse("Cannot delete this medium because it is associated with classes or subjects in academic sessions. Please remove those associations first.");
            // }
    ...
    public function trash($id)
    {
        ...
        try {
            ...
            if (ClassSchool::where('medium_id', $id)->exists() || Subject::where('medium_id', $id)->exists()) {
                ResponseService::errorResponse("Cannot delete this medium permanently because it is associated with classes or subjects in academic sessions. Please remove those associations first.");
            }
