...
class LeaveController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'leave_master_id.required' => 'Some required settings are not configured. Please update the settings to continue using this feature.',
        ...
        try {
            ...
            if ($semester) {
                $this->sessionYearsTrackingsService->storeSessionYearsTracking('App\Models\Leave', $leave->id, $user_id, $sessionYear->id, Auth::user()->school_id, $semester->id);
            } else {
                $this->sessionYearsTrackingsService->storeSessionYearsTracking('App\Models\Leave', $leave->id, $user_id, $sessionYear->id, Auth::user()->school_id, null);
            }
    ...
    public function leave_request()
    {
        ...
        return view('leave.leave_request', compact('leaveMaster', 'sessionYear', 'current_session_year', 'holiday_days', 'users', 'months', 'public_holiday'));
    }
