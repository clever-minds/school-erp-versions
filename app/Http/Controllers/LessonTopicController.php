...
class LessonTopicController extends Controller
{
    ...
    public function show()
    {
        ...
        foreach ($res as $row) {
            ...
            // Get Subject Name
            $subject = $row->lesson->lesson_commons->first()?->class_subject?->subject;
    ...
    public function edit($id)
    {
        ...
        $topic = $this->topic->builder()->with('file', 'lesson.lesson_commons.class_subject.subject', 'lesson_topic_class.class_section')->where('id', $id)->first();
