...
class TeacherController extends Controller {
    ...
    public function __construct(StaffInterface $staff, UserInterface $user, SubscriptionInterface $subscription, CachingService $cache, SubscriptionService $subscriptionService) {
        $this->user = $user;
        $this->staff = $staff;
