    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            Staff::updateOrCreate(
                ['user_id' => $user->id ?? null], // condition
                [
                    'qualification' => $request->qualification,
                    'salary' => $request->salary,
                    'joining_date' => $joining_date,
                    'user_id' => $user->id, // important if creating
                ]
            );
    ...
    public function storeBulkUpload(Request $request)
    {
        ...
        try {
            ...
            if ($request->is_send_notification) {
                $message = 'Data Stored Successfully. Email notifications have been queued and will be sent to teachers shortly.';
            } else {
