...
class SchoolSettingsController extends Controller {
    ...
    public function __construct(SchoolSettingInterface $schoolSettings, CachingService $cachingService, ClassSectionInterface $classSection, StudentInterface $student) {
    ...
    public function index() {
        ...
        return view('settings.school-settings', compact('settings'));
    }
