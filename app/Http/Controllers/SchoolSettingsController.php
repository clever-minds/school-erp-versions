...
class SchoolSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school-settings.general-settings', compact('settings', 'getDateFormat', 'getTimeFormat', 'baseUrlWithoutScheme', 'systemSettings', 'domain_type', 'extraFields'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($settings as $key => $rule) {
                if ($key == 'horizontal_logo' || $key == 'vertical_logo' || $key == 'favicon' || $key == 'login_page_logo') {
