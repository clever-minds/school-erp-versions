...
class FeesTypeController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            // Safety Check: Prevent deletion if fees type is assigned to any class in any session
            if (FeesClassType::where('fees_type_id', $id)->exists()) {
                return ResponseService::errorResponse("Cannot delete this fee type because it is associated with class fees in one or more academic sessions. Please remove it from all class fees first.");
            }
    ...
    public function trash($id)
    {
        ...
        ResponseService::noPermissionThenSendJson('fees-type-delete');
        try {
            // Safety Check: Prevent permanent deletion if fees type is assigned to any class in any session
            if (FeesClassType::where('fees_type_id', $id)->exists()) {
                return ResponseService::errorResponse("Cannot delete this fee type permanently because it is associated with class fees in one or more academic sessions. Please remove it from all class fees first.");
            }
