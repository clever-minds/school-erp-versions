    ...
    public function submitAssignment(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('files')) {
                ...
                $assignmentSubmissionModelAssociate = $fileInstance->modal()->associate($assignmentSubmission); // Get the Association Values of File with Assignment Submission
    ...
    public function getProfileDetails()
    {
        try {
            $studentData = Auth::user()->load(['student' => function ($query) {
                $query->with(['class_section' => function ($subquery) {
